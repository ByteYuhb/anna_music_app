...
public class MockData {
    ...
    public static final String FRIEND_DATA = "{\n"
            ...
            + "      {\n"
            + "        \"type\": 2,\n"
            + "        \"avatr\": \"https://ss0.bdstatic.com/70cFvHSh_Q1YnxGkpoWK1HF6hhy/it/u=1946081712,3056275018&fm=26&gp=0.jpg\",\n"
            + "        \"name\": \"薛定谔的猫\",\n"
            + "        \"fans\": \"357\",\n"
            + "        \"text\": \"一直来为猫铲屎。\",\n"
            + "        \"zan\": \"390\",\n"
            ...
            + "      {\n"
            + "        \"type\": 1,\n"
            + "        \"avatr\": \"http://image.biaobaiju.com/uploads/20180824/00/1535042150-VoZAKDPfQR.jpg\",\n"
            + "        \"name\": \"大张张\",\n"
            + "        \"fans\": \"1240\",\n"
            + "        \"text\": \"为梦想打拼的每一个个体都是发光体。\",\n"
            + "        \"zan\": \"500\",\n"
            + "        \"msg\": \"18\",\n"
            + "        \"pics\": [\n"
            + "          \"http://d.hiphotos.baidu.com/zhidao/pic/item/0df3d7ca7bcb0a4629bbd9f66a63f6246a60af60.jpg\",\n"
            + "          \"http://img3.a0bi.com/upload/ttq/20150829/1440857175281.jpg\",\n"
            + "          \"http://image.biaobaiju.com/uploads/20190624/14/1561359248-SPchNfFCwt.jpg\",\n"
            + "          \"http://imgq.duitang.com/uploads/item/201201/15/20120115160929_vH3jU.thumb.700_0.jpg\"\n"
            + "        ],\n"
            + "        \"audioBean\": {\n"
            + "          \"id\": \"100005\",\n"
